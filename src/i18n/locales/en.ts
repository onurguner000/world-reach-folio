...
export const en = {
  translation: {
    ...
    calendly: {
      ...
      scheduleDescription: "Select a convenient time for a 30-minute consultation to discuss your foreign trade needs.",
      backToHome: "Back to Home",
      loading: "Loading calendar...",
      bookingConfirmed: "Meeting Scheduled!",
      bookingConfirmedDesc: "You will receive a confirmation email shortly with meeting details."
    }
  }
};
