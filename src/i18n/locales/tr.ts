...
export const tr = {
  translation: {
    ...
    servicesDetailed: {
      ...
      flexiblePricing: "Esnek Ücretlendirme Modeli",
      flexiblePricingDesc: "Proje bazlı, saatlik veya komisyon modeli ile hizmet. İthalat danışmanlığında mal bedeli üzerinden yüzdelik komisyon. Detaylı teklif için iletişime geçin.",
      getQuote: "Teklif Al",
      viewDetails: "Detayları Gör",
      services: "Sunduğum Hizmetler",
      successfulProjects: "Başarılı Projeler",
      stats: {
        totalProjects: "Toplam Proje",
        yearsExperience: "Yıl Deneyim",
        successRate: "Başarı Oranı",
        importOperations: "İthalat İşlemi",
        costSavings: "Maliyet Tasarrufu",
        successfulDelivery: "Başarılı Teslimat",
        exports: "İhracat",
        countries: "Ülke",
        revenueIncrease: "Ciro Artışı",
        projects: "Proje",
        clients: "Müşteri",
      ...
      projects: {
        foreignTrade: [
          {
            title: "Medikal Ekipman İthalat Projesi",
            description: "Almanya ve Çin'den dental ekipman ithalatı",
        ...
        compliance: [
          {
            ...
            description: "Medikal ürünler için düzenleyici uyumluluk",
            results: ["Başarılı CE işaretleme", "FDA kayıt desteği", "Dokümantasyon hazırlama"]
          }
        ],
        training: [
          {
            ...
            results: ["25 kişiye dış ticaret eğitimi", "Belge yönetimi çalıştayı", "Süreç standartlaştırma"]
          }
        ],
        support: [
          {
            title: "B2B Fuar Organizasyonu",
            description: "Avrupa fuarlarında organizasyon ve temsil",
            results: ["15+ potansiyel müşteri görüşmesi", "Katalog ve sunum hazırlığı", "5 yeni distribütör anlaşması"]
          }
        ]
      },
      items: {
        ...
        import: {
          ...
          highlight: "İthalat",
          services: [
            "Tedarikçi araştırması ve fabrika doğrulama",
            "GTİP kodu belirleme, gümrük mevzuatı",
            "Sertifikasyonlar (CE, FDA, EAC, RoHS)",
            "Maliyet hesaplama ve risk yönetimi"
          ]
        },
        export: {
          title: "İhracat Danışmanlığı",
          description: "Stratejik pazar genişlemesi",
          stats: "15+ Ülke",
          highlight: "İhracat",
          services: [
            "Pazar araştırması ve giriş stratejisi",
            "Distribütör ağları kurma",
            "Fuar katılımı ve B2B networking",
        ...
        operational: {
          ...
          stats: "Özel Çözüm",
          services: [
            "Dış ticaret departmanı kurulumu",
            "CRM sistem geliştirme",
            "Süreç optimizasyonu"
          ]
        },
        compliance: {
          title: "Mevzuat & Dokümantasyon",
          description: "Gümrük uyumluluğu",
          stats: "Incoterms 2020",
          services: [
            "Gümrük tarife analizi",
            "İzin belgesi takibi",
            "Menşe şahadeti danışmanlığı"
          ]
        },
        training: {
          ...
          services: [
            ...
            "İhracat stratejisi atölyeleri",
            "E-ihracat platform eğitimi",
        ...
        support: {
          ...
          stats: "3 Dil",
          services: [
            "Fuar ve B2B organizasyonu",
            "Rekabet ve fiyat analizi",
            "Çok dilli belge hazırlama"
          ]
        }
      }
    },
    calendly: {
      ...
      scheduleConsultation: "Ücretsiz Danışmanlık Randevusu Alın",
      scheduleDescription: "Dış ticaret ihtiyaçlarınızı görüşmek için uygun bir zaman seçin (30 dakika).",
      backToHome: "Ana Sayfaya Dön",
      loading: "Takvim yükleniyor...",
      bookingConfirmed: "Görüşme Planlandı!",
      bookingConfirmedDesc: "Kısa süre içinde görüşme detaylarını içeren bir onay e-postası alacaksınız."
    }
  }
};
